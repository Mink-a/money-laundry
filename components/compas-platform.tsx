...
function CompasPlatform() {
  return (
    <section className='relative bg-[#015EB9] text-white dark:bg-gray-900'>
      ...
      <div className="absolute hidden lg:block bg-no-repeat bottom-0 left-0 bg-left-top bg-[url('/left-lines.png')] w-full h-full"></div>
    </section>
  );
}
